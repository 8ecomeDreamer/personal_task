<template>
  <div class="wrapper">
    ...
    <div class="table2" v-if="showCompletedTable">
      ...
      <el-table :data="completedOrder.petOrder" stripe style="width: 100%">
        <el-table-column
          prop="salesOrderId"
          label="宠物订单序号"
          width="180"
    ...
    <div class="table3" v-if="unfilledOrders">
      <el-table
        :data="unshippedOrders.petSuppliesOrder"
        stripe
        style="width: 100%"
      >
        <el-table-column
      ...
      <el-table :data="unshippedOrders.petOrder" stripe style="width: 100%">
        <el-table-column
          prop="salesOrderId"
          label="宠物订单序号"
          width="180"
...
export default {
  ...
  methods: {
    ...
    showPetInfo() {
        this.$message('订单确认成功，已更改宠物配送状态');
    },
    showPetSuppliesInfo() {
        this.$message('订单修改成功，已更改宠物用品配送状态');
    },
  },
