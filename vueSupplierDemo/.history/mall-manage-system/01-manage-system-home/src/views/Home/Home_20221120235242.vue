    ...
    <div class="table2" v-if="showCompletedTable">
      ...
      >
        ...
        <el-table-column
          ...
          width="180"
        ></el-table-column>
        <el-table-column prop="salesPetQuantity" label="售卖宠物质量"></el-table-column>
        <el-table-column prop="salesPetPrice" label="售卖宠物价格"></el-table-column>
        <el-table-column prop="petshopName" label="宠物产地"></el-table-column>
        <el-table-column prop="petshopPhone" label="宠物电话"></el-table-column>
        <el-table-column prop="petshopAddress" label="宠物产地具体地址"></el-table-column>
        <el-table-column prop="petshopRemarks" label="宠物质量"></el-table-column>
        <el-table-column prop="orderDate" label="宠物购买日期"></el-table-column>
        <el-table-column prop="salesAllPrice" label="宠物购买金额"></el-table-column>
      </el-table>
    </div>
    <div class="table3" v-if="unfilledOrders">
              <el-table
        :data="completedOrder.petSuppliesOrder"
        stripe
        style="width: 100%"
