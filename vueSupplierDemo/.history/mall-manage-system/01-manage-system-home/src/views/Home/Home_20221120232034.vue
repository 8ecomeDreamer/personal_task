<template>
  <div class="wrapper">
    <div class="btnGroup">
      <el-button type="primary" @click="showTable">查看所有库存</el-button>
      <el-button type="primary" @click="showTable">查看已完成订单</el-button>
      <el-button type="primary" @click="showTable">查看未发货订单</el-button>
    ...
    <el-table :data="petInventory" stripe style="width: 100%">
      <el-table-column prop="stockPetId" label="宠物序号" width="180"></el-table-column>
      <el-table-column prop="specie" label="宠物种类" width="180"></el-table-column>
      <el-table-column prop="price" label="宠物价格"></el-table-column>
      <el-table-column prop="color" label="宠物颜色"></el-table-column>
      <el-table-column prop="price" label="宠物年龄"></el-table-column>
      <el-table-column prop="price" label="宠物体重"></el-table-column>
      <el-table-column prop="price" label="宠物身体状况"></el-table-column>
      <el-table-column prop="price" label="宠物生日"></el-table-column>
      <el-table-column prop="price" label="宠物质量"></el-table-column>
      <el-table-column prop="price" label="宠物产地"></el-table-column>
      <el-table-column prop="price" label="购买日期"></el-table-column>
      <el-table-column prop="price" label="备注"></el-table-column>
    </el-table>
  </div>
