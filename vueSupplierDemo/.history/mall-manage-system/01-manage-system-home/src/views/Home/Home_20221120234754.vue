    ...
    <div class="table2" v-if="showCompletedTable">
      ...
      >
        ...
        <el-table-column
          ...
          width="180"
        ></el-table-column>
        <el-table-column prop="salesAllPrice" label="用品价格"></el-table-column>
        ...
        <el-table-column prop="orderDate" label="用品购买日期"></el-table-column>
        <el-table-column prop="petshopRemarks" label="用品备注"></el-table-column>
      </el-table>
      <el-table
