                  ...
                  <div class="box-content tab-product">
                    <form class="theme-form" @submit.prevent="onSubmit">
                          ...
                          <div class="payment-box">
                            <div class="upper-box">
                              <div class="payment-options row">
                                <div class="radio-option col-md-2">
                                  <input
                      ...
                      <div class="form-row">
                        ...
                        <div class="col-md-12 checkout-page">
                          <label for="email">
                    ...
                    <button @click.prevent="onSubmit" class="btn btn-solid save">
                      {{ $t("general.save") }}
                    </button>
                    <button
                      @click.prevent="onCancel"
                      class="btn btn-solid cancel"
